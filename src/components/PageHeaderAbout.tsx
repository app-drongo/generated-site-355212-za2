...
// Generated: 2025-08-20T15:55:29.680Z
// Section: page-header
...
export default function PageHeaderWithBreadcrumbsAboutPage() {
  const breadcrumbs = [
    { label: "Home", href: "/" },
        ...
        <div className="relative py-12 sm:py-16 lg:py-20">
          ...
          <div className="max-w-4xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-4">
              Our Story: Transforming the Web Development Landscape
            </h1>
            
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl">
              At Acme SaaS, we're on a mission to democratize web development and make beautiful, functional websites accessible to businesses of all sizes. 
              Join us on our journey as we redefine the future of the digital landscape.
            </p>
          </div>
